...
\newcommand{\nombresDelAspirante}{Candelaria}
\newcommand{\apellidoDelAspirante}{Sturm}
\newcommand{\numeroDocumentoDeIdentidadDelAspirante}{41.703.880}
\newcommand{\numeroDiaNacimientoDelAspirante}{26}
\newcommand{\numeroMesNacimientoDelAspirante}{01}
\newcommand{\anioNacimientoDelAspirante}{1999}
\newcommand{\telefonoDelAspirante}{11-2168-9095}
\newcommand{\emailDelAspirante}{sturmcande@gmail.com}

% Opcional: Email alternativo. Si no tenés ninguno, dejalo en blanco.
\newcommand{\emailAlternativoDelAspirante}{cande_sturm@hotmail.com}
